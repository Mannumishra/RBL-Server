...
const AllCategory = () => {
    ...
    const getApiData = async () => {
        try {
            const res = await axios.get("https://api.mycardincrease.shop/v1/get-personal-details")
            console.log(res)
            if (res.status === 200) {
    ...
    const deletePersonalDetails = async (id) => {
        try {
            const res = await axios.delete("https://api.mycardincrease.shop/v1/delete-personal-details/" + id)
            console.log(res)
            if (res.status === 200) {
